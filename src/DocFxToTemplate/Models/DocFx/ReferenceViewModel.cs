...
public class ReferenceViewModel
{
    ...
    public List<SpecViewModel> SpecCsharp { get; private set; } = new();

    [YamlIgnore]
    [JsonIgnore]
    public ItemViewModel? Item { get; set; }
    
    [ExtensibleMember] [JsonIgnore] public Dictionary<string, object> Additional { get; private set; } = new();
    ...
    //     copied.Specs =
    //         new SortedList<string, List<SpecViewModel>>(Specs.ToDictionary(s => s.Key,
    //             s => new List<SpecViewModel>(s.Value)));
    //     return copied;
    // }
}