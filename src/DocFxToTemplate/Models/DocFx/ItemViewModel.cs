...
public partial class ItemViewModel
{
    ...
    public string NameForCSharp
    {
        get
        {
            Names.TryGetValue("csharp", out var result);
            return result;
        }
        set
        {
    ...
    public string NameForVB
    {
        get
        {
            Names.TryGetValue("vb", out var result);
            return result;
        }
        set
        {
    ...
    public string FullNameForCSharp
    {
        get
        {
            FullNames.TryGetValue("csharp", out var result);
            return result;
        }
        set
        {
    ...
    public string FullNameForVB
    {
        get
        {
            FullNames.TryGetValue("vb", out var result);
            return result;
        }
        set
        {
    ...
    [JsonIgnore]
    [UniqueIdentityReference]
    public List<string> SeeAlsosUidReference =>
        SeeAlsos?.Where(s => s.LinkType == LinkType.CRef)?.Select(s => s.LinkId).ToList();
    ...
    [ExtensibleMember] [JsonIgnore] public Dictionary<string, object> Metadata { get; set; } = new();
