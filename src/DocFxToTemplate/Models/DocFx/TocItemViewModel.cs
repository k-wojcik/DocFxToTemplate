...
public class TocItemViewModel
{
    ...
    [YamlIgnore] [JsonIgnore] public string AggregatedHref { get; set; }
    ...
    [YamlIgnore] [JsonIgnore] public string AggregatedUid { get; set; }

    [YamlMember(Alias = "items")]
    [JsonPropertyName("items")]
    public List<TocItemViewModel> Items { get; set; }

    [YamlIgnore] [JsonIgnore] public bool IsHrefUpdated { get; set; }
